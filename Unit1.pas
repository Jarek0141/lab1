...
begin
 ...
 WordApp.Visible := True;
  ...
  Doc.Paragraphs.Item(1).Range.Text :=
    ...
    +#13+ inttostr(Spinedit1.Value)+ '1-плаельщик сбора'+#09+#09+#09+#09+'Сведения о представлении документа'
    +#13+'2-представитель плательщика сбора'
    +#13+ Edit7.Text+#09+#09+#09+#09+'данный документ представлен(код)'
    +#13+ Edit8.Text+#09+#09+#09+#09+'на'+'страницах'
    +#13+ Edit9.Text+#09+#09+#09+#09+'с приложением подтверждающих документов и(или) коий на'+'листах'
    ...
    +#13+'Показатели'+'Код строки'+'Значения показателей'
    +#13+'Код бюджетной классификации'+#09+#09+#09+#09+'010'+edit18.Text
    +#13+'Код по ОКТМО'+#09+#09+#09+#09+'020'+edit19.Text
    +#13+'Общая сумма единовременного взноса, подлежащая уплате в бюджет'+#09+#09+#09+#09+'030'+edit20.Text
...
//for I := 3 to 6 do
 ...
 +#13+inttostr(Spinedit1.Value)+ '1-плаельщик сбора'+'2-представитель плательщика сбора'
 +#13+ Edit7.Text
 +#13+ Edit8.Text
 +#13+ Edit9.Text
 +#13+'(фамили, имя, отчество полностью )'
