...
begin
 ...
 WordApp.Visible := True;
  ...
  Doc.Paragraphs.Item(1).Range.Text :=
    ...
    +#13+'Дата уплаты единовременного взноса'+#09+#09+'040'+#09+#09+#09+#09+#09+#09+DateToStr(DateTimePicker2.DateTime)
    +#13+' '+' '+#09+#09+#09+#09+'серия'+#09+#09+'050'+#09+#09+#09+#09+#09+#09+edit21.Text
    +#13+'Разрешение на добычу'+' '+#09+'номер'+#09+#09+'060'+#09+#09+#09+#09+#09+#09+edit22.Text
    +#13+'(вылов)водных '
